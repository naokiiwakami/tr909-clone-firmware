...
#define PORT_VELOCITY_SNARE_DRUM PORTB
#define BIT_VELOCITY_SNARE_DRUM PB4
#define PORT_PWM_TUNE_SNARE_DRUM PORTB
#define BIT_PWM_TUNE_SNARE_DRUM PB5
#define PORT_PWM_TUNE_BASS_DRUM PORTB
#define BIT_PWM_TUNE_BASS_DRUM PB6
#define PORT_PWM_VELOCITY_BASS_DRUM PORTB
#define BIT_PWM_VELOCITY_BASS_DRUM PB7
...
#define BIT_PWM_VELOCITY_RIM_SHOT  PE4
